...
wv = KeyedVectors.load("default.embeddings", mmap='r') #loading vectors
...
kmeans = KMeans(n_clusters=4) #the best number of clusters
x = vec_df #setting x
...
for i in range(4): #for each of the 4 clusters
